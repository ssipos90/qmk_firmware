...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QRTY] = LAYOUT(
        ...
        KC_LCTL, MO_NMPD, KC_LALT,                   KC_BSPC, MO_NAVI,  KC_SPC,          XXXXXXX, XXXXXXX, MO_CNFG, XXXXXXX,  KC_ENT
    ),
    [_DVRK] = LAYOUT(
        KC_GESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL,  KC_GRV,  KC_BSPC,
        KC_TAB,     KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,
    ...
    [_NMPD] = LAYOUT(
        _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS, KC_EQL,  KC_GRV,  KC_BSPC,
    ...
    [_CNFG] = LAYOUT(
        ...
        XXXXXXX, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, KC_PAUS, XXXXXXX, XXXXXXX,   RESET,
